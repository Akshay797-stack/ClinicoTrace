...
export function NavRail({ active }: { active: string }) {
  ...
  const items: NavItem[] = [
    {
      id: 'patients', label: 'Patients', href: '/doctor',
      icon: (
    ...
    {
      id: 'safety', label: 'Safety', href: '/doctor/safety',
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    ...
    {
      id: 'history', label: 'History', href: '/doctor/history',
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
  ...
  return (
    <nav className="ct-nav-rail">
      ...
      <div style={{
        ...
        marginBottom: '10px', flexShrink: 0, cursor: 'pointer',
